...
flags.DEFINE_string("json_vocab_file", None,
                    "The BPE vocabulary file that the BERT model was trained on.")
...
def write_instance_to_example_files(instances, tokenizer, max_seq_length,
  ...
  for (inst_index, instance) in enumerate(instances):
    ...
    input_ids = [tokenizer.token_to_id(x) for x in instance.tokens]
#     input_ids = tokenizer.convert_tokens_to_ids(instance.tokens)
    ...
    masked_lm_ids = [tokenizer.token_to_id(x) for x in instance.masked_lm_labels]
...
if __name__ == "__main__":
  ...
  flags.mark_flag_as_required("json_vocab_file")
  logging.info("do_whole_word_mask: %s" % FLAGS.do_whole_word_mask)
  logging.set_verbosity(logging.INFO)

  tokenizer = Tokenizer.from_file(FLAGS.json_vocab_file)
  logging.info("BPE Vocab file used : %s " % FLAGS.json_vocab_file)  
# '/mnt/MultilingualTokenization/bpe_tokenizer.json'
