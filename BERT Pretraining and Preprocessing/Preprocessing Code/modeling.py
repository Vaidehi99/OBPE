...
def dropout(input_tensor, dropout_prob):
  ...
  # The second input in tf.nn.dropout has been changed because 
  # the second input in the function definition of tf.nn.dropout
  # has been changed from keep_prob to drop_prob when upgrading
  # from tf1.14 to tf2
...
def layer_norm(input_tensor, name=None):
  ...
  # This code has been changed from the original bert code to make it 
  # compatible to tf2.
